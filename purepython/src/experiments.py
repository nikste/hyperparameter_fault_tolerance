...
def warmstart_all_parallel(fname_in='results_softmax_regression_mnist', dataset='mnist', fname_out='results_softmax_regression_warmstart_mnist'):
    '''
    trains models with warmstarting
    :param x:
    :param y:
    ...
    regularizations = [100., 10., 1., 0.1, 0.01, 0.001, 0.]
